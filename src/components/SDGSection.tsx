...
const sdgGoals = [
  {
    ...
    description: "Significantly reduce deaths, affected people, and economic losses from disasters",
    icon: <Shield className="h-8 w-8" />,
    gradient: "from-orange-500 to-red-500",
    targets: [
      "Reduce disaster-related deaths",
      "Minimize people affected by disasters", 
      "Decrease economic losses",
      "Protect vulnerable populations"
    ],
    resqlinkContribution: "ResQLink's AI-powered triage and BLE mesh networking directly reduces response times and saves lives during emergencies, contributing to lower casualty rates and faster recovery."
  },
  {
    number: "13.1", 
    ...
    resqlinkContribution: "Our platform builds community resilience through real-time disaster monitoring, predictive analytics, and coordinated response capabilities that adapt to changing climate risks."
  }
];
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-20">
          ...
          <p className="text-xl text-[#e0eaff]/70 max-w-3xl mx-auto leading-relaxed mb-12">
            ResQLink directly contributes to achieving the UN's sustainable development goals for disaster resilience and climate adaptation
          </p>
          
          {/* SDG Logo */}
          <div className="flex justify-center mb-12">
            <div className="bg-gradient-to-br from-[#e0eaff]/10 to-[#e0eaff]/5 backdrop-blur-sm border border-[#e0eaff]/20 rounded-2xl p-6 hover:border-[#e0eaff]/40 transition-all duration-300">
              <ImageWithFallback 
                src="https://images.unsplash.com/photo-1748959504388-9eb3143984e6?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxVTiUyMFNERyUyMHN1c3RhaW5hYmxlJTIwZGV2ZWxvcG1lbnQlMjBnb2FscyUyMGxvZ298ZW58MXx8fHwxNzU3MTMyNzI4fDA&ixlib=rb-4.1.0&q=80&w=1080"
          ...
          {sdgGoals.map((goal, index) => (
            ...
            >
              ...
              <div className="flex items-center gap-4 mb-6">
                <div className={`bg-gradient-to-r ${goal.gradient} p-4 rounded-2xl shadow-xl group-hover:scale-110 transition-transform duration-300`}>
              ...
              <div className="mb-8">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  {goal.targets.map((target, targetIndex) => (
                    <div key={targetIndex} className="flex items-center gap-3 text-[#e0eaff]/80">
                      <div className={`w-2 h-2 rounded-full bg-gradient-to-r ${goal.gradient} shadow-lg`}></div>
              ...
              <div className={`bg-gradient-to-r ${goal.gradient} bg-opacity-10 backdrop-blur-sm border border-[#e0eaff]/10 rounded-2xl p-6`}>
                <h4 className="text-[#fefdf5] font-bold mb-3 flex items-center gap-2">
                  <Target className="h-5 w-5" />
                  ResQLink's Impact
                </h4>
                <p className="text-[#e0eaff]/80 leading-relaxed text-sm">
                  {goal.resqlinkContribution}
                </p>
              </div>
              
              {/* Hover effect */}
              <div className={`absolute inset-0 bg-gradient-to-r ${goal.gradient} opacity-0 group-hover:opacity-5 rounded-3xl transition-opacity duration-500`}></div>
            </div>
          ))}
        </div>
        ...
        <div className="text-center mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {impactMetrics.map((metric, index) => (
              ...
              >
                <div className={`bg-gradient-to-r ${metric.gradient} p-3 rounded-xl w-fit mx-auto mb-4 shadow-lg group-hover:scale-110 transition-transform duration-300`}>
                  <div className="text-white">
                    {metric.icon}
                  </div>
                </div>
        ...
        <div className="text-center">
          <div className="bg-gradient-to-r from-blue-500/10 to-green-500/10 backdrop-blur-sm border border-[#e0eaff]/20 rounded-3xl p-8 max-w-4xl mx-auto">
            ...
            <p className="text-[#e0eaff]/70 mb-6 leading-relaxed">
              Partner with ResQLink to build disaster-resilient communities that contribute to global sustainability goals. 
              Together, we can save lives and protect vulnerable populations from climate-related hazards.
            </p>
            <div className="inline-flex items-center gap-3 text-[#e0eaff]/80">
              <Globe className="h-5 w-5" />
              <span className="font-medium">Contributing to a sustainable and resilient future</span>
            </div>
          </div>
        </div>
      </div>
